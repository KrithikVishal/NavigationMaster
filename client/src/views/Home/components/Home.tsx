          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 relative">
              <div className="bg-white rounded-lg shadow-xl p-6 relative z-10">
                <div className="h-64 bg-blue-50 rounded-lg mb-4 flex items-center justify-center">
                      ...
                      <div className="flex">
                        ...
                        <div className="w-2/3 pl-3">
                          ...
                          <div className="flex mb-2">
                            <div className="w-3/4 h-8 bg-primary/20 rounded mr-2"></div>
                            <div className="w-1/4 h-8 bg-gray-200 rounded"></div>
                          </div>
                          <div className="flex mb-2">
                            <div className="w-2/3 h-8 bg-gray-200 rounded mr-2"></div>
                ...
                <div className="absolute top-4 -right-4 bg-white rounded-lg shadow-lg p-4 border border-gray-100">
                  ...
                  <div className="font-medium">24/30</div>
                </div>
              ...
              <div className="absolute top-8 -left-8 w-20 h-20 bg-blue-200 rounded-full opacity-50"></div>
              <div className="absolute bottom-12 -right-12 w-32 h-32 bg-blue-200 rounded-full opacity-50"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Intelligent Solutions</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background rounded-lg p-6 shadow-sm border border-border">
              ...
              <p className="text-foreground mb-4">
                "This platform has transformed how our team works. We've seen a 40% increase in productivity since implementing it across our organization."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-background rounded-lg p-6 shadow-sm border border-border">
              ...
              <p className="text-foreground mb-4">
                "The analytics dashboard gives us insights we never had before. We can make data-driven decisions faster and with more confidence."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-primary/20 mr-3 flex items-center justify-center">
            ...
            <div className="bg-background rounded-lg p-6 shadow-sm border border-border">
              ...
              <p className="text-foreground mb-4">
                "Customer support is exceptional. They helped us customize the platform to fit our unique workflow needs perfectly."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-primary/20 mr-3 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">COO, GrowthStartup</p>
                </div>
              </div>
            </div>
          </div>
